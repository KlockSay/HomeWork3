...
namespace ATframework3demo.PageObjects.roomfy.Adds
{
    ...
    {
        public PreferencesFormCreateAd FillFormPreferences(TestEntities.RoomfyCreateAd agefrom, TestEntities.RoomfyCreateAd ageto, TestEntities.RoomfyCreateAd pricefrom, TestEntities.RoomfyCreateAd priceto)
        {
